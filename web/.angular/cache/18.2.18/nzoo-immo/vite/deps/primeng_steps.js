...
function Steps_li_3_a_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtext(2);
    ɵɵelementEnd();
    ɵɵtemplate(3, Steps_li_3_a_2_span_3_Template, 2, 1, "span", 12)(4, Steps_li_3_a_2_ng_template_4_Template, 1, 1, "ng-template", null, 3, ɵɵtemplateRefExtractor);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function Steps_li_3_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtext(2);
    ɵɵelementEnd();
    ɵɵtemplate(3, Steps_li_3_ng_template_3_span_3_Template, 2, 1, "span", 12)(4, Steps_li_3_ng_template_3_ng_template_4_Template, 1, 1, "ng-template", null, 4, ɵɵtemplateRefExtractor);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function Steps_li_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(2, Steps_li_3_a_2_Template, 6, 18, "a", 9)(3, Steps_li_3_ng_template_3_Template, 6, 9, "ng-template", null, 2, ɵɵtemplateRefExtractor);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
var Steps = class _Steps extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    standalone: true,
    features: [ɵɵProvidersFeature([StepsStyle]), ɵɵInputTransformsFeature, ɵɵInheritDefinitionFeature, ɵɵStandaloneFeature],
    decls: 4,
    vars: 9,
    ...
    template: function Steps_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵtemplate(3, Steps_li_3_Template, 5, 13, "li", 7);
        ɵɵelementEnd()();
      }
      if (rf & 2) {
    ...
    dependencies: [CommonModule, NgClass, NgForOf, NgIf, NgStyle, RouterModule, RouterLink, TooltipModule, Tooltip, SharedModule],
    encapsulation: 2,
    changeDetection: 0
  });
};
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(Steps, {
    className: "Steps"
  });
})();
...
(function() {
  (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(StepsModule, {
    imports: [Steps, SharedModule],
    exports: [Steps, SharedModule]
  });
})();
