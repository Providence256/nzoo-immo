...
var Splitter = class _Splitter extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    standalone: true,
    features: [ɵɵProvidersFeature([SplitterStyle]), ɵɵInputTransformsFeature, ɵɵInheritDefinitionFeature, ɵɵStandaloneFeature],
    decls: 3,
    vars: 12,
    ...
    template: function Splitter_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵstyleMap(ɵɵpureFunction1(10, _c2, ctx.layout === "vertical" ? "column" : ""));
